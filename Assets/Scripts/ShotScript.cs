...
public class ShotScript : MonoBehaviour
{
    ...
    private Vector2 PrepareVector(Vector2 vectorToPrepare)
    {
        ...
        pushVector *= StrengthScale * mainCameraMovementScript.CameraSize / startCameraSize;

        pushVector.x = Mathf.Clamp(pushVector.x, -MaxTensionByX * StrengthScale, MaxTensionByX * StrengthScale);
        pushVector.y = Mathf.Clamp(pushVector.y, -MaxTensionByY * StrengthScale, MaxTensionByY * StrengthScale);
    ...
    void Start()
    {
        ...
        startCameraSize = mainCameraMovementScript.CameraSize;
    }
